...
describe('safeTryCatch utilities', () => {
  ...
  describe('safeTryCatchAsync', () => {
    it('should return result on success', async () => {
      const [error, result] = await safeTryCatchAsync(async () => 'async success')
      expect(error).toBeNull()
...
describe('paper_quotes validation', () => {
  ...
  it('should validate effect claim with paper_quotes', async () => {
    ...
    const effectsVocab = await loadVocabulary('test-effects-vocab', testVocabDir)
  ...
  it('should validate biomarker claim with paper_quotes', async () => {
    ...
    const biomarkersVocab = await loadVocabulary('test-biomarkers-vocab', testVocabDir)
